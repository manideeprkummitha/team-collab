...
export const WorkspaceSidebar = () => {
    ...
    console.log("Modal open state:", _open);
    ...
    if (workspaceLoading || memberLoading) {
        console.log("Loading Workspace or Member...");
        return (
    ...
    if (!workspace || !member) {
        console.log("Workspace or Member not found");
        return (
    ...
    console.log("Rendering WorkspaceSidebar");
    ...
    return (
        <div className='flex flex-col bg-[#5E2C5F] h-full'>
            ...
            <WorkspaceSection
                ...
                onNew={() => console.log("New Direct Message clicked")}
            >
                {members?.map((item) => (
                    <UserItem 
                        key={item._id}
